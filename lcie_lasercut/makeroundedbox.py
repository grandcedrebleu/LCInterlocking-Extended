...
import Part
import math
from lcie_lasercut.roundedboxproperties import RoundedBoxProperties, TopBottomRoundedProperties
import lcie_lasercut.helper as helper
from lcie_lasercut.makehinges import do_intersection
