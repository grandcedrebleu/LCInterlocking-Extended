...
import FreeCAD
from lcie_lasercut import helper
from lcie_lasercut.material import retrieve_thickness_from_biggest_face
from lcie_lasercut.makehinges import complete_hinges_properties, create_solid_corner, estimate_min_link
import copy
