...
LCInterlocking Extended 1.2.0 is generated from the pinned LCInterlocking upstream
...
The derived-geometry patch is applied after Python package namespacing by
`scripts/patch_derived_geometry.py` to the generated Extended package.
