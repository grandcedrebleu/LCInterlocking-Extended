...
from lcie_lasercut.hingesproperties import GlobalLivingMaterialProperties
from lcie_lasercut.hingesproperties import HingesProperties
from lcie_panel.toolwidget import ParamWidget, WidgetValue
