...
import os
from lcie_lasercut.join import make_tabs_joins
from lcie_panel.treepanel import TreePanel, PREVIEW_NONE, PREVIEW_NORMAL, PREVIEW_FAST
...
Gui.addCommand('LCIE_multiple_tabs_command', MultipleCommand())
