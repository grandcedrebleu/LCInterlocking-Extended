...
class LCInterlockingExtendedWorkbench(Workbench):
    MenuText = "Laser Cut Interlocking Extended"
...
"""
    ...
    def Initialize(self):
        import LCIE_ExportPanel
        import LCIE_MakeBoxPanel
        import LCIE_MakeRoundedBoxPanel
        ...
        self.appendToolbar("Hinge", ["LCIE_make_rounded_box_command", "LCIE_livinghinge"])
        self.appendToolbar("Export", ["LCIE_export_command"])
