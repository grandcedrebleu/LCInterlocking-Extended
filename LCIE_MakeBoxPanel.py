...
import Draft
import copy
from lcie_panel.box import BoxProperties, TopBottomProperties, DimensionBoxParam, LengthWidthBoxParam, BottomBoxParam, TopBoxParam
from lcie_lasercut import makebox
...
Gui.addCommand('LCIE_make_box_command', MakeBoxCommand())
